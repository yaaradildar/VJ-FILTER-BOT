...
PICS = (environ.get('PICS', 'https://graph.org/file/3ad10a754ddaf36567877-1d40b8dd815327e77b.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1996039956').split()] # For Multiple Id Use One Space Between Each.
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002131144121').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002318362767') # give your force subscribe channel id here else leave it blank
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '@aisehineedthibot')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://dildaaryaara:dildarcluster01@cluster0.hpxj6.mongodb.net/?retryWrites=true&w=majority")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
O_DB_URI = environ.get('O_DB_URI', "mongodb+srv://MRDAXX:MRDAXX@mrdaxx.prky3aj.mongodb.net/?retryWrites=true&w=majority")   # This Db Is For Other Data Store
F_DB_URI = environ.get('F_DB_URI', "mongodb+srv://dildaar:DF9mb6XfI2QUy57K@cluster0.2orwy.mongodb.net/?retryWrites=true&w=majority")   # This Db Is For File Data Store
S_DB_URI = environ.get('S_DB_URI', "mongodb+srv://dildaar:DF9mb6XfI2QUy57K@cluster0.2orwy.mongodb.net/?retryWrites=true&w=majority")   # This Db is for File Data Store When First Db Is Going To Be Full.
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/THUKRA_KE_MERA_PYAAR_EPISODES')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'moviedillu') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/moviedillu')
